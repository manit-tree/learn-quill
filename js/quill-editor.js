function createEditor(element) {    
    ...
    function _createEditor() {
        ...
        sb.push('<div class="ql-toolbar">');
        sb.push('<button data-action="h1" title="Header 1"></button>');
        sb.push('<button data-action="h2" title="Header 2"></button>');
        sb.push('<button data-action="h3" title="Header 3"></button>');
        sb.push('<button data-action="h4" title="Header 4"></button>');
        sb.push('<span class="seperator"></span>');
            
        sb.push('<button data-action="bold" title="bold"></button>');
        sb.push('<button data-action="italic" title="italic"></button>');
        sb.push('<span class="seperator"></span>');

        sb.push('<button data-action="align-left" title="align left"></button>');
        sb.push('<button data-action="align-center" title="align center"></button>');
        sb.push('<button data-action="align-right" title="align right"></button>');
        sb.push('<span class="seperator"></span>');

        sb.push('<button data-action="ordered-list" title="ordered list"></button>');
        sb.push('<button data-action="unordered-list" title="unordered list"></button>');
        sb.push('<span class="seperator"></span>');

        sb.push('<button data-action="color" title="color"></button>');
        sb.push('<button data-action="hilight" title="hilight"></button>');
        sb.push('<span class="seperator"></span>');

        sb.push('<button data-action="phone" title="telephone"></button>');
        sb.push('<button data-action="email" title="email"></button>');
        sb.push('<button data-action="link" title="link"></button>');
        sb.push('<span class="seperator"></span>');

        sb.push('<button data-action="lorem-ipsum" title="lorem ipsum"></button>');
        sb.push('<button data-action="blockquote" title="blockquote"></button>');
        sb.push('<button data-action="remove-format" title="remove format"></button>');
        sb.push('</div>');

        sb.push('<div class="editor" spellcheck="false"></div>');

        $element.append(sb.join(''));
    }

    _createEditor();

    var quill = new Quill($element.find('.editor').get(0), {
        modules: {
            toolbar: $element.find('.ql-toolbar').get(0)
        },
        theme: 'snow',
        readOnly: false
    });   
